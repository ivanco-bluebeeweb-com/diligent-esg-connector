"""Settings panel for Diligent ESG Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__diligent_esg_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=diligent_esg_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_diligent_esg"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Diligent ESG Settings & Accounts", level=2),
