# PST Testing Scenarios for Diligent ESG Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_diligent_esg_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_diligent_esg_connector` without lingering secrets.
